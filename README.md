...
<ul>
  ...
  <li>Cleaned data from apartments.com and engineered features from raw text describing apartment amenities by applying NLP processing techniques to gain insight on what amenities might be useful to include in the final model  
...
* [Guide](https://towardsdatascience.com/productionize-a-machine-learning-model-with-flask-and-heroku-8201260503d2) on productionizing an ML model (used for reference on how to pickle and load a model)  
